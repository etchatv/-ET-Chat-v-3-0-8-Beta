--
-- Tabellenstruktur f�r Tabelle 'etchat_blacklist'
--
...
--
-- Daten f�r Tabelle 'etchat_blacklist'
--
...
--
-- Tabellenstruktur f�r Tabelle 'etchat_messages'
--
...
-- limit --
--
-- Daten f�r Tabelle 'etchat_messages'
--
...
--
-- Tabellenstruktur f�r Tabelle 'etchat_rooms'
--
...
-- limit --
--
-- Daten f�r Tabelle 'etchat_rooms'
--
...
(2, 'Room for all', 0, NULL, 'All chat user are allowed to enter this Room.<hr />Alle Chatbenutzer dürfen diesen Raum betretten.'),
...
--
-- Tabellenstruktur f�r Tabelle 'etchat_smileys'
--
...
-- limit --
--
-- Daten f�r Tabelle 'etchat_smileys'
--
...
--
-- Tabellenstruktur f�r Tabelle 'etchat_user'
--
...
--
-- Tabellenstruktur f�r Tabelle 'etchat_useronline'
--
...
--
-- Daten f�r Tabelle 'etchat_useronline'
--

-- --------------------------------------------------------

--
-- Tabellenstruktur f�r Tabelle `etchat_config`
--
...
-- limit --
--
-- Daten f�r Tabelle 'etchat_config'
--
